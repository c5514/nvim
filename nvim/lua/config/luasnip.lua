...
set(mode, '<c-t>','<cmd>lua _G.dynamic_node_external_update(1)<Cr>' )
set(mode, '<c-g>', '<cmd>lua _G.dynamic_node_external_update(2)<Cr>')
set(mode, '<c-e>', '<Plug>luasnip-next-choice')
